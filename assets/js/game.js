...
var fight = function(enemy) {
    ...
    while(enemy.health > 0 && playerInfo.health > 0) {
        ...
        if (fightOrSkip()) {
            // if true, leabe the fight by breaking the loop
            break;
        }
...
var shop = function() {
    ...
    var shopOptionPrompt = window.prompt(
        "Would you like to REFILL your health, UPGRADE your attack, or LEAVE the store? Please enter one (1) for REFILL, two for (2) UPGRADE, or three (3) for LEAVE."
    ); 
